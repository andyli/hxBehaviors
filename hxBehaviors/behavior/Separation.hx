package hxBehaviors.behavior;
	...
	class Separation extends Behavior {
		...
		public var separateList:Iterable<Vehicle>;
		
		public function new(?separateList:Iterable<Vehicle> = null, ?separateDist:Int = 9, ?separateAngle:Int = 135, ?separateStrength:Float = 0.95)
		{
			super();
